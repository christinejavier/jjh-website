...
gulp.task("default", function(callback){
	...
	runSequence("styles", ["pug", "api", "js", "sync", "watch"], callback)
});

// updates all files, dev build
gulp.task("build", function(callback){
	//finish rm task before all others async
	runSequence("rm", "styles", ["pug", "api", "js", "images", "fav"], callback)
});

//run for production version
gulp.task("build:prod", function(callback){
	//finish rm task before all others async
	runSequence("rm", "styles", ["pug:prod", "api", "js", "images", "fav"], callback)
});
